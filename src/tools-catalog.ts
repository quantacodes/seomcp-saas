...
export const TOOLS: ToolInfo[] = [
  ...
  // IndexNow
  {
    ...
    description: "Submit a single URL for faster search engine indexing via IndexNow protocol",
    category: "indexnow",
    categoryIcon: "🚀",
    params: [
      { name: "url", type: "string", required: true, description: "URL to submit" },
      { name: "key", type: "string", required: false, description: "IndexNow API key (uses server default if omitted)" },
      { name: "dry_run", type: "boolean", required: false, description: "Validate without actually submitting" },
    ],
    tier: "free",
  },
  {
    name: "indexnow_batch_submit",
    description: "Submit multiple URLs at once for faster indexing",
    category: "indexnow",
    categoryIcon: "🚀",
    params: [
      { name: "urls", type: "string[]", required: true, description: "URLs to submit" },
      { name: "key", type: "string", required: false, description: "IndexNow API key" },
      { name: "dry_run", type: "boolean", required: false, description: "Validate without submitting" },
    ],
    tier: "free",
  },
  {
    name: "indexnow_submit_sitemap",
    description: "Parse a sitemap and submit all URLs via IndexNow",
    category: "indexnow",
    categoryIcon: "🚀",
    params: [
      { name: "sitemap_url", type: "string", required: true, description: "Sitemap URL to parse" },
      { name: "key", type: "string", required: false, description: "IndexNow API key" },
      { name: "max_urls", type: "number", required: false, description: "Max URLs to submit" },
      { name: "dry_run", type: "boolean", required: false, description: "Validate without submitting" },
    ],
    tier: "free",
  },
  {
    ...
    description: "Submit URLs from a text file (one URL per line)",
    category: "indexnow",
    categoryIcon: "🚀",
    params: [
